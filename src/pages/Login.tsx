    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12">
        ...
        <div className="text-center mb-10">
          <img src={dainLogo} alt="DAIN Studios" className="h-12 w-auto mx-auto mb-6" />
          <h1 className="heading-display text-foreground mb-3">
            Knowledge
            <br />
            <span className="text-primary">Flywheel</span>
          </h1>
          <p className="text-muted-foreground text-lg max-w-md mx-auto">
            Capture, curate, and share knowledge effortlessly
          </p>
        </div>
